...
export default function RegistrationForm({eventname}) {
  ...
  const collegeOptions = [
    ...
    { value: "6",     label: "B.S.Abdur Rahman Crescent Institute of Science & Technology" },
    ...
    { value: "2704",  label: "Coimbatore Institute of Engineering and Technolgoy (Autonomous)" },
    ...
    { value: "2709",  label: "Government College of Engineering (Formerly Institute of Road and Transport Technology" },
    ...
    { value: "2718",  label: "Sri Krishna College of Enginering and Technology (Autonomous)" },
    ...
    { value: "3461",  label: "Arifa Institute of Technology(Formly Haji sheik Ismail Engineering College) Nagappatinam District" },
    { value: "3462",  label: "Ariyalur Engineering College Ariyalur District" },
    { value: "3464",  label: "Government College of Engineering Gandarvakotta Thanjavur District" },
    { value: "3465",  label: "Government College of Engineering Srirangam Thiruchirappalli District" },
    { value: "3466",  label: "Nelliandavar Institute of Technology Ariyalur Dsitrict" },
    { value: "3701",  label: "K Ramakrishnan College of Technology (Autonomous) Thiruchirappally District" },
    { value: "3760",  label: "Sir Issac Newton College of Engineering and Technology Nagappatinam Distric" },
    { value: "3766",  label: "Star Lion College of Engineering and Technology Thanjavur District" },
    { value: "3782",  label: "OASYS Institute of Technology Thiruchirapalli District" },
    { value: "3786",  label: "M.A.M. School of Engineering Thiruchirappalli District" },
    { value: "3795",  label: "SRM TRP Engineering College Thiruchirappalli District" },
    { value: "3801",  label: "A V C College of Engineering Mayiladuthurai District" },
    { value: "3802",  label: "Shri Angalamman College of Engineering and Technology Thiruchirappalli District " },
    { value: "3803",  label: "Anjalai Ammal Mahalingam Engineering College Thiruvarur District" },
    { value: "3804",  label: "Arasu Engineering College Thanjavur District" },
    { value: "3805",  label: "Dhanalakshmi Srinivasan Engineering College Perambalur District" },
    ...
    { value: "4968",  label: "Sardar Raja College of EngineeringSardar Raja College of Engineering" },
    ...
    { value: "5842",  label: "SRM Madurai College for Engineering and Technology (Formely Madurai Institute of Engineering and Technology)" },
    { value: "5851",  label: "Veerammal Engineering College" },
    { value: "5862",  label: "R V S Educational Trust's Groups of Institutions (Integrated Campus) " },
    ...
    { value: "5910",  label: "P S N A Colllege of Engineering and Technology (Autonomous)" },
      ...
      >
        ...
        <div>{/* <label htmlFor="college">College</label> */}
          <Select
            ...
            placeholder={ collegename == null ? "Select your college " : collegename.label }
          />
        </div>
